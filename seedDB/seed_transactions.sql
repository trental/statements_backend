...
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('purchase_ppe', 'transaction_date', 'date');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('purchase_ppe', 'accounting_date', 'date');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('purchase_ppe', 'cost_of_ppe', 'number');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('purchase_ppe', 'description', 'text');
...
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) 
VALUES ('salary_and_employment_expenses', 'transaction_date', 'date');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('salary_and_employment_expenses', 'accounting_date', 'date');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) 
VALUES ('salary_and_employment_expenses', 'salary_paid_general_and_administrative', 'number');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) 
VALUES ('salary_and_employment_expenses', 'employment_expenses_accrued_general_and_administrative', 'number');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('salary_and_employment_expenses', 'salary_paid_sales_and_marketing', 'number');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('salary_and_employment_expenses', 'employment_expenses_accrued_sales_and_marketing', 'number');
insert into statements_transaction (transaction_type, transaction_property, transaction_property_datatype) VALUES ('salary_and_employment_expenses', 'description', 'text');